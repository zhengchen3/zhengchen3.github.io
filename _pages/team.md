...
<p>
Zheng Chen is a  Specially Appointed Associate Professor at SANKEN, Osaka University, within [Sakurai & Matsubara Lab](https://www.dm.sanken.osaka-u.ac.jp) at SANKEN, Osaka University.
Before joining SANKEN, he received his Ph.D. from the Nara Institute of Science and Technology (NAIST). His research lies at the intersection of machine learning, biomedical engineering, and biomedical data science, with a focus on EEG modeling, AI systems for clinical diagnosis, computational frameworks for multi-omics analysis, and agentic AI workflows for scientifc dicovery and translational research. His work has been published in leading conferences and journals, including ICLR, NeurIPS, KDD, Nature Biomedical Engineering, and Scientific Data. He works closely with computer scientists, bioinformaticians, and researchers in neuroscience and oncology. His research also involves collaborations with industry partners such as Keiji AI and Guardant Health on AI-driven biomedical data analysis.
</p>
